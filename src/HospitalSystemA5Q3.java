...
public class HospitalSystemA5Q3 {
    ...
    private final InputOutputInterface io = new DialogIO();
    ...
    public void dropAssociation() {
        ...
        io.outputString("*******************");
        io.outputString("The new list is : " + p);
    }
    ...
    public static void main(String args[]) {
        ...
        HospitalSystemA5Q3 hs = new HospitalSystemA5Q3();
        io.outputString("Select a method to perform :" +
                "\n0: quit" +
                "\n1: add a new patient to system" +
                "\n2: add a new doctor to system" +
