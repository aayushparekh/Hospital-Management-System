...
public class Ward
{
     ...
     * whether the beds are available
     * or not.
     * @return : returns a list of available beds
     */
    public ArrayList<Integer> availableBeds()
    {
        ...
        return list;// returns the list with available beds
    }

    /**
     * The below method is the
     * method which is used to check
     * whether a particular bed label
     * is empty or not.
     * @param bedlabel : It stores the bed label
     */
    public void freeBed(int bedlabel) // Takes bedlabel as parameter
    {
        if (bedlabel<minBedLabel || bedlabel>getMaxBedLabel())
            throw new IllegalArgumentException("The bedlabel" + bedlabel + "cannot be less than minBedlabel or " +
                    "greater than getMaxBedLabel. ");
    ...
    public static void main(String[] args)
    {
        ...
        if (w.getPatient(205) != p) {
            System.out.println("getPerson() or isOccupied() failed: Person Pete should be in bed 205, but " + w.getPatient(205) + " is.");
            numErrors++;
        }
        if (! w.getPatient(205).getName().equals("Pete")) {
            System.out.println("getPerson() or isOccupied() failed: Pete should be in bed 205, but " + w.getPatient(205) + " is.");
            numErrors++;
        }
        ...
        if (w.getPatient(1) != p) {
            System.out.println("getPerson() or isOccupied() failed: Person Dan should be in bed 1, but " + w.getPatient(1) + " is.");
            numErrors++;
        }
        ...
        {
            System.out.println("Something is invalid in available beds");
            numErrors++;
        }
        ...
        {
            System.out.println("Something is invalid in free bed");
            numErrors++;
        }
